...
Command: npx gltfjsx@6.5.3 public/models/68c4a04fe57f6e1987f1203a.glb 
*/
...
export function Avatar(props) {
  ...
  const { actions } = useAnimations([typeAnimation[0], standAnimation[0], fallAnimation[0]], group);
  ...
  //   }
  //   if (cursorFollow) {
  //     const target = new THREE.Vector3(state.pointer.x, state.pointer.y, 1); // z is 1 to make it look at us as z-axis is outwards the screen
